...
<body id="t" i18n-values=".style.fontFamily:fontfamily;.style.fontSize:fontsize" class="offline" style="font-family: 'Helvetica Neue', 'Lucida Grande', sans-serif; font-size: 75%;">
  <div id="main-frame-error" class="interstitial-wrapper">
    <div id="main-content">
      ...
      <div id="main-message">
        ...
        <p>인터넷이 연결되지 않았거나 잘못된 페이지를 요청하셨습니다. 이는 당신이 게임을 할 수 있다는 뜻입니다! 즐기세요!</p>
        <div class="error-code" jscontent="errorCode">THANKS TodayCook FOR THIS GAME</div>
      </div>
    </div>
  ...
  <div id="sub-frame-error">
    ...
    <div id="sub-frame-error-details" jsvalues=".innerHTML:errorDetails">연결을 읽어버렸어요 으아아앙ㅠㅠ</div>
  </div>
