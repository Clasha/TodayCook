...
<!-- <div class="panel panel-default">
        <div class="panel-body"> -->
            ...
            <textarea style="width:490px;height:600px">
오늘의 요리 이용약관은 다음과 같은 내용을 담고 있습니다. (2015년 9월 22일 시행)
...
이 약관은 전기통신사업법령 및 정보통신망이용촉진등에 관한 법령에 의하여 (주)에스에이유씨이(이하 "회사"라 합니다)가 운영하는 오늘의 요리 인터넷 서비스 (이하 “서비스"라 한다)의 이용조건 및 절차에 관한 사항을 규정함을 목적으로 합니다.
 
제 2 조 (약관의 효력 및 변경) 

(1) 이 약관은 회사가 그 내용을 서비스 화면을 통해 게시하고 이용자가 이에 동의를 함으로써 효력을 발생합니다. 
(2) 회사는 합리적인 사유가 있을 경우 약관규제에 관한 법률, 정보통신망 이용촉진 및 정보보호등에 관한 법률 등 관련법을 위배하지 않는 범위에서 본 약관을 변경할 수 있으며, 이 경우 적용일자 및 개정사유를 명시하여 현행약관과 함께 오늘의 요리의 초기화면에 그 적용일자 7일이전부터 적용일자 전일까지 공지합니다. 다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이 경우 오늘의 요리는 개정전 내용과 개정후 내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다. 
...
회원은 개인정보수정을 통해 언제든지 개인정보를 열람하고 수정할 수 있습니다. 
...
(1) 오늘의 요리는 회원이 서비스를 이용할 때 필요하다고 인정되는 다양한 정보의 추가 또는 변경내용을 공지사항이나 e-mail 등의 방법으로 회원에게 제공할 수 있습니다. 회원은 동 정보의 제공을 원하지 않는 경우 정보수신 거부를 할 수 없습니다. 
(2) 회원이 오늘의 요리의 제휴사에서 제공하는 서비스를 이용할 경우, 회원은 제휴사에서 서비스 이용에 대하여 별도의 서비스 이용 절차를 필요로 하는 경우 서비스이용 신청을 하고 해당 서비스를 이용할 수 있습니다. 
...
라.장기간 비로그인으로 인하여 휴면회원으로 변경된 경우 
    ...
    2. 회원이 이용약관을 통해서 오늘의 요리 회원가입 후 서비스를 이용하는 도중 6개월 동안 로그인을 하지 않으면 회사는 회원으로 하여금 서비스 이용을 제한할 수 있습니다. 
...
단, 제22조 2항에 해당이 되어 오늘의 요리에서 조사중인 경우에는 해지신청을 하실 수 없습니다. 
...
전자상거래등에서의소비자보호에관한법률 제36조(전속관할)조항에 따라, 오늘의 요리와 이용자간에 발생한 전자거래 분쟁에 관한 소송은 제소 당시의 이용자의 주소에 의하고, 주소가 없는 경우에는 거소를 관할하는 지방법원의 전속 관할로 합니다. 다만, 제소 당시 이용자의 주소 또는 거소가 분명하지 아니 하거나, 외국 거주자의 경우에는 민사소송법상의 관할법원에 제기합니다.

[부칙]

부 칙 (2015. 9. 22 개정) 
1. (시행일) 본 약관은 2015년 9월 22일부터 시행합니다. 
