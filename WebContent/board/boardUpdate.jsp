	...
	<div id="wrap" align="center">
		...
		<form name="frm" method="post" action="BoardServlet">
			...
			<table>
				<tr>
					<th>작성자</th>
					<td><input type="text" size="12" name="nick"
						value="${board.nick}"> </td>
				</tr>
				<tr>
					<th>제목</th>
					<td><input type="text" size="70" name="subject"
			...
			<br> <input type="submit" value="수정"
				onclick="location.href='BoardServlet?command=board_update'"> 
				<input type="reset" value="다시 작성"> <input type="button" value="목록"
